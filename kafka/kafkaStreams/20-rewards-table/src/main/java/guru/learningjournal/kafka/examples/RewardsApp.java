...
public class RewardsApp {
    ...
    public static void main(String[] args) {
        ...
        builder.stream(AppConfigs.posTopicName,
            Consumed.with(AppSerdes.String(), AppSerdes.PosInvoice())
                ...
                .map((key, invoice) -> new KeyValue<>(
                    invoice.getCustomerCardNo(), Notifications.getNotificationFrom(invoice)
                ...
                .toStream().to(AppConfigs.notificationTopic, Produced.with(AppSerdes.String(), AppSerdes.Notification()));
